...
<body >
 ...
 <div class="container">
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> WELCOME TO SCI-TECH INSTITUTE <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
             ...
             <div class="row text-center">
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                     ...
                     <p data-scroll-reveal="enter from the bottom after 0.3s" >
                      We are bunch of professionals from almost each corner of Bangladesh, educated from different institues, with technical and non-technical backgrounds, and with lot of other non commonalities but we have a common thing which is that we all are striving hard to bring the highest quality tutorials for our lovely readers. It took us almost 2 years to build this large library and we are still continuing.
                         </p>
                 </div>
