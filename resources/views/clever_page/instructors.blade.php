...
<body>
                            ...
                            <ul>
                                ...
                                <li><a href="#">Pages</a>
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="/single-course">Single Courses</a></li>
    ...
    <div class="instructors-video d-flex align-items-center justify-content-center bg-img" style="background-image: url(clever_temp/img/bg-img/bg4.jpg);">
